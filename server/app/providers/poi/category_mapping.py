...
LABELS = {
    ...
    "entertainment": "休闲娱乐", "nature": "自然", "other": "其他",
}
...
def amap_category(typecode: str | None, source: str | None) -> str:
    ...
    return {"05": "food", "06": "shopping", "07": "service", "08": "entertainment", "09": "health", "10": "lodging", "11": "attraction", "12": "service", "14": "education", "15": "transport", "16": "transport", "17": "transport", "18": "transport", "19": "service"}.get(prefix, "other")
